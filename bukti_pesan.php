...
<html lang="en">
<head>
  <title><?php echo "Airlangga Hotel - ".$nama; ?></title>
  <meta charset="utf-8">
...
<div id="invoice">
    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
            <header>
                <div class="row">
                    ...
                    <div class="col company-details">
                        ...
                        <div>Jember Jawa Timur, ID 89023, INA</div>
                        <div>(123) 47213</div>
                        <div>airlanggahotel@gmail.com</div>
                    </div>
                </div>
            </header>
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <div class="address">Jember, TX 79273, Indonesia</div>
            ...
            <footer>
                Bukti pemesanan kamar Hotel Airlangga Jember - Jawa Timur - Indonesia.
            </footer>
        </div>
